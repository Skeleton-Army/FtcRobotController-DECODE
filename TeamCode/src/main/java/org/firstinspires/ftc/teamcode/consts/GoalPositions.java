...
public class GoalPositions {
    ...
    public final static Pose BLUE_GOAL_FAR = new Pose(6, FULL_FIELD_LENGTH);
    public final static Pose RED_GOAL_FAR = new Pose(FULL_FIELD_LENGTH - BLUE_GOAL_FAR.getX(), BLUE_GOAL_FAR.getY());

    public final static Pose CLOSE_AUTO_BLUE_GOAL = new Pose(6, FULL_FIELD_LENGTH - 2);
    public final static Pose CLOSE_AUTO_RED_GOAL = new Pose(FULL_FIELD_LENGTH - CLOSE_AUTO_BLUE_GOAL.getX(), CLOSE_AUTO_BLUE_GOAL.getY());

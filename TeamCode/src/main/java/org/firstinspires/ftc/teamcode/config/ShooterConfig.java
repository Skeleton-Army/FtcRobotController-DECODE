...
public class ShooterConfig {
    ...
    public static double TURRET_POSITION_TOLERANCE = Math.toRadians(0.5);
    public static double TURRET_VELOCITY_TOLERANCE = Math.toRadians(30);
    public static double TURRET_IZONE = Math.toRadians(30);
    public static double TURRET_KI_MAX_INTEGRAL = 0.1; // rad*s
    ...
    public static double TURRET_MIN_VOLTAGE = 0.5;
    ...
    public static double DIST_FAR = 200; // Inches
    public static double WINDOW_CLOSE = Math.toRadians(2.0); // Max error allowed when close
    ...
    public static double VELOCITY_WINDOW_GAIN = Math.toRadians(0.0); // Window growth per inch/sec of speed
    public static double MAX_WINDOW_SIZE = Math.toRadians(2.0); // Absolute limit for the window

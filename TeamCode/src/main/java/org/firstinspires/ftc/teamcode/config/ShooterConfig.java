...
public class ShooterConfig {
    ...
    public static double FLYWHEEL_KP = 3;
    public static double FLYWHEEL_KP_DOWN = 14;
    public static double FLYWHEEL_KI = 0;
    public static double FLYWHEEL_KD = 0;
    public static double FLYWHEEL_KS = 195;
    public static double FLYWHEEL_KA = 1.2;
    public static double FLYWHEEL_KA_DOWN = 2;
    public static double FLYWHEEL_KV = 1.15;

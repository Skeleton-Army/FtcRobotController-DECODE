...
import static org.firstinspires.ftc.teamcode.consts.ShooterCoefficients.MAX_VEL_COEFFS_FAR;
import static org.firstinspires.ftc.teamcode.consts.ShooterCoefficients.MIN_VEL_COEFFS_FAR;
...
public class ShooterCalculatorFar implements IShooterCalculator {
    ...
    private final double[] hoodCoeffs = ShooterCoefficients.HOOD_COEFFS_FAR;

    public ShooterCalculatorFar() {
    ...
    private HoodSolution lookup(double distance, double velocity) {
        ...
        double minLimit = evaluatePolynomial(MIN_VEL_COEFFS_FAR, distance);
        double maxLimit = evaluatePolynomial(MAX_VEL_COEFFS_FAR, distance);

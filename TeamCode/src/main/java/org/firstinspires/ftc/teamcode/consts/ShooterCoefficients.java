...
public class ShooterCoefficients {
    ...
    private static final double[] HOOD_COEFFS = {-0.01019346, 0.15389212, -0.91188978, 2.65911739, -3.89362224, 3.03329116};

    private static final double[] MIN_VEL_COEFFS = {0.02770411, -0.38846154, 2.07521833, -5.17235799, 6.88146406, 1.32267170};

    private static final double[] MAX_VEL_COEFFS = {-0.01138695, 0.13700431, -0.58997567, 1.04296726, 0.59121101, 3.55756520};
}
...
public class MotorTesting extends OpMode {
    ...
    @Override
    public void init() {
        prompter.prompt("motorType", new OptionPrompt<>("Select motor type to test", MotorType.DcMotor, MotorType.Servo))
                ...
                .prompt("motorToTest", () -> {
                   ...
                   if ( selectedMotor == MotorType.DcMotor) {
                ...
                */
                .prompt("dcMotorRPM", () -> {
                    if (prompter.get("motorType") == MotorType.DcMotor) {
    ...
    private void startTest() {
        boolean startTest = prompter.get("startTest");
        MotorType motorType;
        int motorMaxRPM;
        String motorName;

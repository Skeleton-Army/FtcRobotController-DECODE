...
import static org.firstinspires.ftc.teamcode.consts.ShooterCoefficients.MAX_VEL_COEFFS_CLOSE;
import static org.firstinspires.ftc.teamcode.consts.ShooterCoefficients.MIN_VEL_COEFFS_CLOSE;
...
public class ShooterCalculatorClose implements IShooterCalculator {
    ...
    private final double[] hoodCoeffs = ShooterCoefficients.HOOD_COEFFS_CLOSE;

    public ShooterCalculatorClose() {
    ...
    private HoodSolution lookup(double distance, double velocity) {
        ...
        double minLimit = evaluatePolynomial(MIN_VEL_COEFFS_CLOSE, distance);
        double maxLimit = evaluatePolynomial(MAX_VEL_COEFFS_CLOSE, distance);

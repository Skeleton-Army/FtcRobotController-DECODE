...
public class KalmanConfig {
    ...
    public static Pose processVariance = new Pose(0,0, Math.toRadians(0)); // the drift covariance
    public static Pose measurementVariance = new Pose(500,500, Math.toRadians(1)); // the apriltag covariance
